...
Gem::Specification.new do |spec|
  spec.name          = "itamae-plugin-recipe-nginx-build"
  spec.version       = Itamae::Plugin::Recipe::Nginx::Build::VERSION
  spec.authors       = ["zaru"]
  ...
  spec.homepage      = "https://github.com/zaru/itamae-plugin-recipe-nginx-build"
